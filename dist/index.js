...
var _PageTodo = __webpack_require__(74);

var _PageTodo2 = _interopRequireDefault(_PageTodo);

var _weexLui = __webpack_require__(78);
...
exports.default = {
  ...
  computed: _extends({
    cumpTitle: {
      get: function get() {
        ...
        return this.classify === 'add' ? this.newTodoItem.title : this.currentTodoItem.title;
      },
    ...
    cumpDesc: function cumpDesc() {
      return this.classify === 'add' ? this.newTodoItem.desc : this.currentTodoItem.desc;
    },
    cumpBeginDate: function cumpBeginDate() {
      var item = 'currentTodoItem';
      if (this.classify === 'add') {
        item = 'newTodoItem';
      }
      console.log(item);
    ...
    cumpSection: function cumpSection() {
      var item = 'currentTodoItem';
      if (this.classify === 'add') {
        item = 'newTodoItem';
      }
      return this[item].section > -1 ? this.sectionItems[this[item].section] : '选择开始日期';
    }
  }, (0, _vuex.mapState)('list', {
    statusIcon: 'statusIcon',
    statusList: 'statusList',
  ...
  methods: _extends({}, (0, _vuex.mapMutations)('pageConfig', ['setPageRef', 'setPageTitle']), (0, _vuex.mapMutations)('list', ['setItemClassify', 'setCurrentList', 'setTodoItemByDream', 'addTodoItemByDream']), {
    ...
    pickSection: function pickSection() {
      var _this2 = this;
      ...
      picker.pick({
        ...
        if (event.result === 'success') {
          _this2.newTodoItem.section = event.data;
        }
      });
    },
    ...
    changeTodoItem: function changeTodoItem() {
      var dream = this.currentList.dream;
    ...
    addTodoItem: function addTodoItem() {
      if (this.newTodoItem.title.length !== 0) {
        var date = new Date();
        var localeDate = date.toLocaleDateString().split('/').join('-');
        var localeTime = date.toTimeString().split(' ')[0];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "autofocus": true,
      "placeholder": "填写清单事项",
      "value": (_vm.newTodoItem.title)
    },
    on: {
      "input": function($event) {
        _vm.$set(_vm.newTodoItem, "title", $event.target.attr.value)
      }
    }
  })]), _c('div', {
    ...
    staticClass: ["beginsection"],
    on: {
      "click": _vm.pickSection
    }
  }, [_vm._v(_vm._s(_vm.newTodoItem.section > -1 ?
    this.sectionItems[_vm.newTodoItem.section] : '选择区间'))])]), _c('div', {
    staticClass: ["describe"]
  }, [_c('text', {
    staticClass: ["describe-txt"]
  }, [_vm._v("描述: ")]), _c('textarea', {
    staticClass: ["desc-textarea"],
    attrs: {
      "type": "text",
      "autofocus": "",
      "placeholder": "填写该事项的具体描述",
      "value": (_vm.newTodoItem.desc)
    },
    on: {
      "input": function($event) {
        _vm.$set(_vm.newTodoItem, "desc", $event.target.attr.value)
      }
    }
  })])]), _c('div', {
...
exports.WeexPage = undefined;

var _weexPage = __webpack_require__(79);

var _weexPage2 = _interopRequireDefault(_weexPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.WeexPage = _weexPage2.default;
...
var _tabConfig = __webpack_require__(87);

var _tabConfig2 = _interopRequireDefault(_tabConfig);

var _dreamList = __webpack_require__(88);

var _dreamList2 = _interopRequireDefault(_dreamList);

var _pageConfig = __webpack_require__(89);
...
var state = {
  ...
  sectionItems: ['08:00-09:00', '09:30-11:00', '13:00-15:00', '16:00-17:00', '19:00-20:00', '21:00-22:00'],
  list: [{
    key: 0,
    bgColor: '#CC4422',
    status: 0, // 
...
var mutations = {
  ...
  setCurrentTodoItem: function setCurrentTodoItem(state, _ref) {
    var item = _ref.item;

    state.currentTodoItem = item;
  },
  setTodoItemByDream: function setTodoItemByDream(state, _ref2) {
    var dream = _ref2.dream,
        item = _ref2.item;

    var listItem = state.list.filter(function (value) {
      return value.dream === dream;
    })[0];
    var dolistItem = listItem.dolist.filter(function (value, index) {
      // console.log(value);
  ...
  addTodoItemByDream: function addTodoItemByDream(state, _ref3) {
    var dream = _ref3.dream,
        item = _ref3.item;

    var listItem = state.list.filter(function (value) {
      return value.dream === dream;
    })[0];
    var todoLen = listItem.dolist.length;
    listItem.dolist[todoLen] = item;
    console.log(listItem);
  },
  setItemClassify: function setItemClassify(state, _ref4) {
    var key = _ref4.key,
        value = _ref4.value;

    state.list[key].classify = value;
  },
  deleteDolistByKey: function deleteDolistByKey(state, _ref5) {
    var dream = _ref5.dream,
        createdate = _ref5.createdate;
...
var mutations = {
  ...
  setDetailMaskShow: function setDetailMaskShow(state, bool) {
